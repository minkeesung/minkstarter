...
users = User.create!([
  {name: "Guest", email: "guest@guest.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/quickstarter_avatar.png"},
  {name: "Chang Lee", email: "changlee@gmail.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/timbuktu_avatar.jpg"},
  {name: "Bob", email: "bob@bob.com", password: "password"},
  {name: "Sue de Beer Studio", email: "studio@studio.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/sue_avatar.jpg"},
  {name: "Ursula Murray Husted", email: "ursula@ursula.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/ursula_avatar.jpg"},
  {name: "Nova Iskra", email: "nova@nova.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/folkk_avatar.png"},
  {name: "Input Club", email: "input@input.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/input_club_avatar.png"},
  {name: "Garrett Martin", email: "garrett@garrett.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/garrett_avatar.jpg"},
  {name: "Senic", email: "senic@senic.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/senic_avatar.jpg"},
  {name: "eto wine", email: "eto@eto.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/eto_avatar.jpg"},
  {name: "John Vanderslice", email: "john@john.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/vanderslice_avatar.jpeg"},
  {name: "Rise Grand Rapids", email: "rise@rise.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/grand_rapids_avatar.png"},
  {name: "Timbuktu Labs", email: "timbuktu@timbuktu.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/timbuktu_avatar.jpg"},
  {name: "Freshly Picked", email: "freshly@freshly.com", password: "password", image_url: "https://s3.amazonaws.com/minkstarter1/freshly_picked_avatar.png"},
])
...
v = Project.create!(
  ...
  category_id: c.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/wood_keyboard.jpg",
...
n = Project.create!(
  ...
  category_id: a.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/lions_of_valletta.jpeg",
...
category_id: b.id,
image_url: "https://s3.amazonaws.com/minkstarter1/folkk.jpg",
...
j = Project.create!(
  ...
  category_id: a.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/white_wolf.jpg",
...
x = Project.create!(
  ...
  category_id: e.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/mountain_climb.jpg",
...
y = Project.create!(
  ...
  category_id: e.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/drone.jpg",
...
z = Project.create!(
  ...
  category_id: i.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/covi_light.jpg",
...
aa = Project.create!(
  ...
  category_id: c.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/eto.png",
...
ad = Project.create!(
  ...
  category_id: g.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/tiny_telephone.jpg",
...
ah = Project.create!(
  ...
  category_id: f.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/grand_rapids.png",
...
ak = Project.create!(
  ...
  category_id: h.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/rebel_girls.jpg",
...
an = Project.create!(
  ...
  category_id: d.id,
  image_url: "https://s3.amazonaws.com/minkstarter1/sneakers.jpg",
